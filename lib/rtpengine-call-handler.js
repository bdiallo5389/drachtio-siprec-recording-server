...
module.exports = (req, res) => {
  ...
  parseSiprecPayload(opts)
    ...
    .catch((err) => {
      ...
      if (opts.rtpengineCallerSdp) {
        rtpEngine.delete(rtpEngine.remote, opts.callDetails)
          .catch((delErr) => logger.error({ delErr }, 'Failed to release caller rtpengine endpoint'));
      }
